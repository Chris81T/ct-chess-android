...
public class KingView extends AbstractFigureView {

    public KingView(Context context, int figureColor) {
        super(context, figureColor);
    }

    public KingView(Context context, AttributeSet attrs, int figureColor) {
        super(context, attrs, figureColor);
    }

    public KingView(Context context, AttributeSet attrs, int defStyleAttr, int figureColor) {
        super(context, attrs, defStyleAttr, figureColor);
    }

    @Override
    protected int getDrawableId(int figureColor) {
        return figureColor == ColorType.WHITE ? basic_king_white: basic_king_black;
    }
