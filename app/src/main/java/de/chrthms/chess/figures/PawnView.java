...
import static de.chrthms.chess.R.drawable.basic_pawn_black;

/**
 * Created by christian on 01.01.17.
 */

public class PawnView extends AbstractFigureView {

    public PawnView(Context context, int figureColor) {
        super(context, figureColor);
    }

    public PawnView(Context context, AttributeSet attrs, int figureColor) {
        super(context, attrs, figureColor);
    }

    public PawnView(Context context, AttributeSet attrs, int defStyleAttr, int figureColor) {
        super(context, attrs, defStyleAttr, figureColor);
    }

    @Override
    protected int getDrawableId(int figureColor) {
        return figureColor == ColorType.WHITE ? basic_pawn_white: basic_pawn_black;
    }
