...
public class RookView extends AbstractFigureView {

    public RookView(Context context, int figureColor) {
        super(context, figureColor);
    }

    public RookView(Context context, AttributeSet attrs, int figureColor) {
        super(context, attrs, figureColor);
    }

    public RookView(Context context, AttributeSet attrs, int defStyleAttr, int figureColor) {
        super(context, attrs, defStyleAttr, figureColor);
    }

    @Override
    protected int getDrawableId(int figureColor) {
        return figureColor == ColorType.WHITE ? R.drawable.basic_rook_white: R.drawable.basic_rook_black;
    }
